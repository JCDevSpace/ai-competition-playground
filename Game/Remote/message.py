...
class Message:
    """
    Message is a static class that encapsulates the various message processing and convertion functionalities, provides the ability to convert between the different message formats specificed in the protocol into internal data presentations.
    ...
    @classmethod
    def list2d_converter(cls, value):
